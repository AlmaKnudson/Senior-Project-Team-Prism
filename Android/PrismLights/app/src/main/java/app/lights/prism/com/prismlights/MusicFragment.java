...
public class MusicFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStatusTextView = new TextView(getActivity());
        mLinearLayout = new LinearLayout(getActivity());
        mLinearLayout.setOrientation(LinearLayout.VERTICAL);
        mLinearLayout.addView(mStatusTextView);

        getActivity().setContentView(mLinearLayout);

        //Create the MediaPlayer
        //WTF should I do instead of R.id.micButton-->
        mMediaPlayer = MediaPlayer.create(getActivity(), R.id.micButton);
        //Log some shiznit-->
