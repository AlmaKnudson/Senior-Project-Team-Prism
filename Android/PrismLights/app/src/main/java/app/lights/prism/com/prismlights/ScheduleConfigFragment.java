        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("")) {
                    ...
                    currentDialog = DialogCreator.showWarningDialog("Error", "Name is too long. Please enter shorter name.", (MainActivity) getActivity());
                } else if (timeChoiceOn==-1 && timeChoiceOff==-1){
                    currentDialog = DialogCreator.showWarningDialog("Error", "Please enter On time or Off time", (MainActivity) getActivity());
                } else if (recurringDays == 0){
                    currentDialog = DialogCreator.showWarningDialog("Error", "Please choose at least one day.", (MainActivity) getActivity());
                } else {
