...
\begin{itemize}
Team Prism will use group texting for day-to-day communcation, Google Hangouts for virtual team meetings, issue tracking in Git for code related communication, and Version One for agile planning. Team members will be able to call each other for any urgent issues that might come about. 
Team Prism will have a brief stand-up meeting at the beginning of each week.  In this meeting, each member will state what they accomplished during the previous week, what they plan to accomplish in the upcoming week, and any roadblocks that they may have run into during the week.  After this stand-up meeting, each team member will be given an opportunity to express any concerns about the efficiency of the team during the previous week and offer ideas on how to improve performance as a team.
\end{itemize}
\clearpage
